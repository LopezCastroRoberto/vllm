...
class ComputePrefillMetadataKernel:
    ...
    def get_warmup_keys(self: Any, vllm_config: VllmConfig) -> list[CompileKey]:
    ...
    def compile(self: Any, compile_key: CompileKey) -> None:
        warmup = getattr(self.triton_kernel, "warmup", None)
...
class DeepseekSparseSWAMetadataBuilder(AttentionMetadataBuilder):
    ...
    def _build_deepseek_v4_metadata(
        ...
        if num_prefills > 0:
            ...
            cast(Any, ComputePrefillMetadataKernel)(
                pfx_gather_lens,
                seq_lens,
                query_start_loc,
                num_prefills,
