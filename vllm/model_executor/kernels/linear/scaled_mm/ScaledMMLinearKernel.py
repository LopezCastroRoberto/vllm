...
from vllm.model_executor.layers.utils import _ll_gemm_fp8_scaled_mm
...
class FP8ScaledMMLinearKernel(
    ...
    def apply_weights(
        ...
        # Use LL FP8 GEMM for small M
        ll_out = _ll_gemm_fp8_scaled_mm(x_2d_q, w, x_s, w_s, bias, output_shape)
